...
pub struct SearchAllRequest {
    ...
    pub pagination: ::core::option::Option<
        crate::mods::grpc_api::bilibili_pagination::Pagination,
    >,
    ///
    #[prost(message, optional, tag = "11")]
    pub player_args: ::core::option::Option<
        crate::mods::grpc_api::bilibili_app_archive_middleware_v1::PlayerArgs,
    >,
}
///
#[allow(clippy::derive_partial_eq_without_eq)]
...
pub struct SearchAllResponse {
    ...
    #[prost(message, optional, tag = "11")]
    pub pagination: ::core::option::Option<
        crate::mods::grpc_api::bilibili_pagination::PaginationReply,
    >,
    ///
    #[prost(message, optional, tag = "12")]
