...
pub fn postwebpage(url: String,content: String,proxy_open: bool,proxy_url: String,user_agent: String) -> Result<String, ()> {
    let mut data = Vec::new();
    let mut handle = Easy::new();
...
pub async fn async_postwebpage(url: &str,content: &str,proxy_open: &bool,proxy_url: &str,user_agent: &str) -> Result<String, ()> {
    let url = url.to_owned();
